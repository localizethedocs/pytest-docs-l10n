...
function createProvenanceDropdown() {
  ...
  const upstreamDocs  = "https://docs.pytest.org";
  const upstreamRepo  = "https://github.com/pytest-dev/pytest";
  ...
  const mainContent = document.querySelector('div[class="article-container"]');
  if (mainContent) {
