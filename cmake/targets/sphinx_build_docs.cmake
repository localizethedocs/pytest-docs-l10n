...
set(UPSTREAM_DOCS   "https://docs.pytest.org")
set(UPSTREAM_REPO   "https://github.com/pytest-dev/pytest")
if     (VERSION MATCHES "^(latest)$" OR
        VERSION MATCHES "^(stable)$")
    set(INSERT_POINT    "div[class=\"article-container\"]")
elseif (VERSION MATCHES "^([0-9]+)$")
    if     (VERSION VERSION_LESS_EQUAL    "9" AND
            VERSION VERSION_GREATER_EQUAL "8")
        set(INSERT_POINT    "div[class=\"article-container\"]")
    elseif (VERSION VERSION_LESS_EQUAL    "7" AND
